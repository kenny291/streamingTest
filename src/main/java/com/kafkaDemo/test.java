 ...
 * simple, non-windowed aggregation on an unbounded set of keys will use an
 * unbounded amount of state. When this is an issue, look at the SQL/Table API,
 * or ProcessFunction, or state TTL, all of which provide mechanisms for
 * expiring state for stale keys.
 */
